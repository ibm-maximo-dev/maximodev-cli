...
cli.process(schema, process.argv, add_aln_domain_values);


function add_aln_domain_values(result) {
  console.log(result);
  //Populate variables
  ...
  dm.innerAlnValueInfo(domainid, script_name, value, value_description);
